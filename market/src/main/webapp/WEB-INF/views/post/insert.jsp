...
<div class="container mt-4">
	...
	<form action="<c:url value='/post/insert/${co_num}'/>" method="post" enctype="multipart/form-data">
		...
		<div class="form-group" id="addressContainer" style="display: none;">
		    <label for="address">직거래 주소</label>
		    <input type="text" class="form-control" id="address" name="address" placeholder="주소를 입력하세요" onfocus="searchAddress()">
		    <div id="addressResults" style="display:none; border: 1px solid #ccc; max-height: 200px; overflow-y: auto;"></div>
		</div>
